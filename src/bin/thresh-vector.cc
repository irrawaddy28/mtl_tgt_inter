...
int main(int argc, char *argv[]) {
  try {
    ...
    po.Register("disable-upper-cap", &disable_upper_cap, "Disable upper capping. If value > threshold, use value instead of upper cap");
