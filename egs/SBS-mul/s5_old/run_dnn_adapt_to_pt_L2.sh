...
# ./run_dnn_adapt_to_pt_L2.sh --stage 2 --replace-softmax "false" "SW" exp/tri3b_map_SW_pt  exp/dnn4_pretrain-indbn_dnn/nnet_SW_pt/nnet.init data-fmllr-tri3b exp/dnn4_pretrain-indbn_dnn/nnet_SW_pt
# ./run_dnn_adapt_to_pt_L2.sh --stage 2 --replace-softmax "true"  "SW" exp/tri3b_map_SW_pt  exp/dnn4_pretrain-indbn_dnn/nnet_SW_pt/nnet.init data-fmllr-tri3b exp/dnn4_pretrain-indbn_dnn/nnet_SW_pt
#                                                              
...
if [ $stage -le 2 ]; then
  ...
  for train_iters in {20..20..1}; do  #{1..5..1}
    for l2_penalty_fac in -40; do  #-11.0 -10.75 -10.5 -10.25 -10.0 -9.75 
	  dir=${nnet_dir}_xentit_${train_iters}_l2_${l2_penalty_fac}; mkdir -p $dir 
	  nnet_init=$dir/nnet.init
	  l2_penalty=`perl -e 'print STDOUT exp('$l2_penalty_fac');'`;  
	  ...
	  echo "nnet_init = ${nnet_init}, train_iters = ${train_iters}, l2 = ${l2_penalty}"
