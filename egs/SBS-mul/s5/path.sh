if [ `hostname` == "ifp-48" ]; then
  ...
  export randomizer_size=131072   # per-job size = 2^18 = 262144 fills about 750 MB in GPU
  ...
  export randomizer_size=262144   # per-job size = 2^18 = 262144 fills about 750 MB in GPU
  export minibatch_size=512
fi
